...
//
// Note: this list only covers names generated by gcode itself. Framework-level
// method names (e.g. GORM's TableName, BeforeCreate, AfterSave) are not
// included; avoiding those collisions is the user's responsibility.

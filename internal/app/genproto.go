...
func buildProtoHeader(sb *strings.Builder, f model.File, relPath string) {
	...
	imports := collectImports(relPath)
...
//
// Known limitation: cross-package enum references are not supported.
// If a message references an enum from a different package, the generated
// proto will be missing that import and will fail to compile. Users must
// add such imports manually.
func collectImports(relPath string) []string {
